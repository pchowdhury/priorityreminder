...
public class AlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		try {
			...
			broadcastIntent.putExtra(context.getString(R.string.intent_taskitem_message),
					bundle.getByteArray(context.getString(R.string.intent_taskitem_message)));
